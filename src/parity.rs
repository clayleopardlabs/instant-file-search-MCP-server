...
mod parity_tests {
    ...
    fn parity_battery() {
        ...
        let queries: &[(&str, Option<&str>)] = &[
            ...
            ("file:", Some(r"B:\Projects\instantaneous-windows-file-search-mcp-server")),
    ...
    fn parity_dump_everything() {
        for q in [
            ...
            "file: B:\\Projects\\instantaneous-windows-file-search-mcp-server",
            "file: B:\\Projects\\instantaneous-windows-file-search-mcp-server\\plugin\\node_modules",
            "file: B:\\Projects\\instantaneous-windows-file-search-mcp-server !<node_modules\\>",
            "file: !<node_modules\\> B:\\Projects\\instantaneous-windows-file-search-mcp-server",
            "dm:2026-07-01",
            "dm:2026-06-01",
            "file: dm:2026-07-01",
            "dm:2026-07-02",
