...
| `content:` | `content:"fn main"` | Match file contents. Memory mode uses a bounded 256 MB cache. Disk mode can use a temporary SQLite cache with a configurable budget. |
