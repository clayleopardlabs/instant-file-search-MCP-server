...
const plugin = async (_input, _options) => {
    return {
        tool: {
            find_files: tool({
                description: "INSTANT file/directory search using Everything engine (NTFS index). " +
                ...
                args: {
                    query: z
                        .string()
                        .min(1)
                        .describe("Search query. Supports Everything modifiers: file:*.ts, dm:today, " +
                    ...
                    include_all: z
                        .boolean()
                        .optional()
                        .describe("When true, search without auto-excluding noise folders " +
                    ...
                    match_path: z
                        .boolean()
                        .optional()
                        .describe("Match against the full path, not just the filename. Default: false."),
                    max_results: z
                        .number()
                        .max(100)
                        .optional()
                    ...
                    offset: z
                        .number()
                        .optional()
                        .describe("Pagination offset. Use with max_results: offset=0 (page 1), " +
                        "offset=100 (page 2), etc. Default: 0."),
                    sort: z
                        .string()
                        .optional()
                        .describe("Sort order: name, name_desc, path, path_desc, size, size_asc, " +
                    ...
                    fields: z
                        .string()
                        .optional()
                        .describe("Comma-separated fields: filename, path, size, date_modified, " +
                ...
                execute: async (args, _context) => {
                    const text = await callMCP("find_files", args);
                    return JSON.parse(text);
                },
            }),
            count_files: tool({
                description: "INSTANT count of matching files using Everything engine (NTFS index). " +
                ...
                args: {
                    ...
                    include_all: z
                        .boolean()
                        .optional()
                        .describe("When true, count without auto-excluding noise folders. Default: false."),
                    regex: z
                        .boolean()
                        .optional()
                ...
                execute: async (args, _context) => {
                    const text = await callMCP("count_files", args);
                    return JSON.parse(text);
                },
            }),
            search_status: tool({
                description: "Check if Everything search engine is running and IPC is connected. " +
